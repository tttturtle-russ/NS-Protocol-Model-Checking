...
#define PanSource	"../injective-agreement.pml"
...
#define _nstates2	39	/* Eve */
#define minseq2	149
#define maxseq2	186
#define _endstate2	38

#define _nstates1	80	/* Bob */
#define minseq1	70
#define maxseq1	148
#define _endstate1	79

#define _nstates0	71	/* Alice */
#define minseq0	0
#define maxseq0	69
...
#define PEve	((P2 *)_this)
typedef struct P2 { /* Eve */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	#endif
#endif
	unsigned AliceAgree : 1;
	unsigned BobAgree : 1;
	unsigned AliceSuccess : 1;
	unsigned BobSuccess : 1;
	uchar Num;
	uchar ch;
	struct Message sendBuffer[255];
	struct Message receiveBuffer[255];
#ifdef TRIX
...
void qsend(int, int, int, int, int, int, int, int, int, int, int);
